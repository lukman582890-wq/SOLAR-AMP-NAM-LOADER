...
$p=$p.Replace('<ProgramDatabaseFile>$(PDB_FILE)</ProgramDatabaseFile>','<ProgramDatabaseFile>$(PDB_FILE)</ProgramDatabaseFile>\n      <AdditionalLibraryDirectories>$(IPLUG2_ROOT)\Dependencies\Extras\WebView2\build\native\x64;%(AdditionalLibraryDirectories)</AdditionalLibraryDirectories>')
